...
import static chessengine.board.Board.*;
...
public abstract class Move {
    ...
    public static  class PawnEnPassantAttackMove extends PawnAttackMove{
        ...
        @Override //Верни, что это значение теперь равно другому
        // или является other является объектом класса PawnEn...
        //а полям в конструкторе суперкласса присвой значения other
        public boolean equals(final Object other){
